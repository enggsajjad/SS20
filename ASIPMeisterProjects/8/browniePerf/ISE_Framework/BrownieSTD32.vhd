...
-- Generated by ASIP Meister 2.3 on 2020/06/18 18:28:16 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal const_32h00007fff : std_logic_vector(31 downto 0);
  signal ua_altsel01_dout : std_logic_vector(31 downto 0);
  signal const_32h00000000 : std_logic_vector(31 downto 0);
  signal const_32h00000058 : std_logic_vector(31 downto 0);
  signal ua_altsel03_dout : std_logic_vector(31 downto 0);
  signal ua_altsel04_dout : std_logic_vector(31 downto 0);
  signal ua_altsel05_dout : std_logic_vector(31 downto 0);
  signal ua_altsel06_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_altsel07_dout : std_logic_vector(31 downto 0);
  ...
  signal const_17h00000 : std_logic_vector(16 downto 0);
  signal bitrange31to17_00 : std_logic_vector(14 downto 0);
  signal const_18h00000 : std_logic_vector(17 downto 0);
  signal bitrange31to18_00 : std_logic_vector(13 downto 0);
  signal const_19h00000 : std_logic_vector(18 downto 0);
  signal bitrange31to19_00 : std_logic_vector(12 downto 0);
  signal bitpos2_01 : std_logic;
  ...
  signal uf_alu2_result : std_logic_vector(31 downto 0);
  signal bitpos3_01 : std_logic;
  signal uf_alu3_result : std_logic_vector(31 downto 0);
  ...
  signal uf_alu2_cin : std_logic;
  signal uf_alu2_mode : std_logic_vector(4 downto 0);
  signal uf_alu3_cin : std_logic;
  signal uf_alu3_mode : std_logic_vector(4 downto 0);
  ...
  signal ua_mux27_sel : std_logic_vector(2 downto 0);
  ...
  signal unused_08 : std_logic_vector(3 downto 0);
  signal unused_09 : std_logic;
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      r_sel0 => ua_mux27_dout, 
      r_sel1 => ua_mux28_dout, 
  ...
  UA_ALTSEL00 : rtg_mux2to1_w32
    port map (
      SEL => bitor_00, 
      DIN0 => const_32h00007fff, 
      DIN1 => const_32hffff8000, 
  ...
  UA_ALTSEL02 : rtg_mux2to1_w32
    port map (
      SEL => bitor_00, 
      DIN0 => const_32h00000058, 
      DIN1 => const_32h00000000, 
      DOUT => ua_altsel02_dout
    );

  UA_ALTSEL03 : rtg_mux2to1_w32
    port map (
      SEL => bitor_03, 
      DIN0 => ua_preg02_dout, 
      DIN1 => ua_altsel02_dout, 
      DOUT => ua_altsel03_dout
    );

  UA_ALTSEL04 : rtg_mux2to1_w32
    port map (
      SEL => bitpos2_01, 
      DIN0 => const_32h00000000, 
      DIN1 => concat_06, 
      DOUT => ua_altsel04_dout
    );

  UA_ALTSEL05 : rtg_mux2to1_w32
    port map (
      SEL => bitpos1_00, 
      DIN0 => const_32h00000000, 
      DIN1 => concat_07, 
      DOUT => ua_altsel05_dout
    );

  UA_ALTSEL06 : rtg_mux2to1_w32
    port map (
      SEL => bitpos0_00, 
      DIN0 => const_32h00000000, 
      DIN1 => concat_08, 
      DOUT => ua_altsel06_dout
    );

  UA_ALTSEL07 : rtg_mux2to1_w32
    port map (
      SEL => bitpos3_01, 
      DIN0 => uf_alu2_result, 
      DIN1 => uf_alu3_result, 
      DOUT => ua_altsel07_dout
    );
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLOUT_ALU2_MODE => uf_alu2_mode, 
      CTRLOUT_ALU2_CIN => uf_alu2_cin, 
      CTRLOUT_ALU3_MODE => uf_alu3_mode, 
      CTRLOUT_ALU3_CIN => uf_alu3_cin, 
  ...
  UA_MUX04 : rtg_mux4to1_w32
    port map (
      SEL => ua_mux04_sel, 
      DIN0 => const_32hffff8000, 
      DIN1 => const_32h00000000, 
      DIN2 => ua_altsel05_dout, 
      DIN3 => ua_preg07_dout, 
      DOUT => ua_mux04_dout
    );
  ...
  UA_MUX07 : rtg_mux15to1_w32
    port map (
      ...
      DIN11 => ua_altsel01_dout, 
      DIN12 => ua_altsel03_dout, 
      DIN13 => ua_altsel07_dout, 
  ...
  UA_MUX29 : rtg_mux3to1_w32
    port map (
      SEL => ua_mux29_sel, 
      DIN0 => const_32h00007fff, 
      DIN1 => const_32h00000058, 
      DIN2 => ua_altsel06_dout, 
      DOUT => ua_mux29_dout
    );

  UA_MUX30 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux30_sel, 
      DIN0 => concat_09, 
      DIN1 => ua_preg02_dout, 
  ...
  const_32h00007fff <= "00000000000000000111111111111111";
  bitrange1to0_01 <= uf_alu1_flag(1 downto 0);
  cmpeq_03 <= 
	'1' when bitrange1to0_01 = "10" else 
	'0';
  cmpeq_04 <= 
	'1' when bitrange1to0_01 = "01" else 
	'0';
  bitor_02 <= cmpeq_03 or cmpeq_04;
  bitor_03 <= bitor_00 or bitor_02;
  const_32h00000000 <= "00000000000000000000000000000000";
  const_32h00000058 <= "00000000000000000000000001011000";
  bitrange3to0_00 <= ua_preg02_dout(3 downto 0);
  bitpos3_01 <= bitrange3to0_00(3);
  bitrange31to16_01 <= ua_preg02_dout(31 downto 16);
  concat_06 <= const_16h0000 & bitrange31to16_01;
  const_17h00000 <= "00000000000000000";
  bitrange31to17_00 <= ua_preg02_dout(31 downto 17);
  concat_07 <= const_17h00000 & bitrange31to17_00;
  const_18h00000 <= "000000000000000000";
  bitrange31to18_00 <= ua_preg02_dout(31 downto 18);
  concat_08 <= const_18h00000 & bitrange31to18_00;
  const_19h00000 <= "0000000000000000000";
  bitrange31to19_00 <= ua_preg02_dout(31 downto 19);
  concat_09 <= const_19h00000 & bitrange31to19_00;
  bitpos2_01 <= bitrange3to0_00(2);
  bitpos1_00 <= bitrange3to0_00(1);
  bitpos0_00 <= bitrange3to0_00(0);
  bitnot_02 <= not uf_alu2_result;
