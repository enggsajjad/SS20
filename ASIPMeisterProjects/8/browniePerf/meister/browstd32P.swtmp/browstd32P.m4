...
m4_define(<<<<__RTL_TEMPLATES__>>>>,<<<<(define_insn "builtin_brownie32_CLAMPV"
[
...
m4_define(<<<<__INIT_BUILTINS__>>>>,<<<<tree ftype_CLAMPV = build_function_type_list (integer_type_node, integer_type_node, NULL_TREE);
tree ftype_CLAMPI = build_function_type_list (integer_type_node, integer_type_node, NULL_TREE);
tree ftype_VALPRED = build_function_type_list (integer_type_node, integer_type_node, integer_type_node, NULL_TREE);

builtin_function ("__builtin_brownie32_CLAMPV", ftype_CLAMPV, CODE_FOR_builtin_brownie32_CLAMPV, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_CLAMPI", ftype_CLAMPI, CODE_FOR_builtin_brownie32_CLAMPI, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_VALPRED", ftype_VALPRED, CODE_FOR_builtin_brownie32_VALPRED, BUILT_IN_MD, NULL, NULL_TREE);
>>>>)
