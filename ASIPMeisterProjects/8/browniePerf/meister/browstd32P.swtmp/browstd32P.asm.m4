...
/*CLAMPV*/
{ 
  "CLAMPV", "CLAMPV %rd , %rs1 ",
  32,
  5,
  { 
    { "op_code0", 0, 6, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 5, 2, "2", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code2", 11, 11, 2, "2", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs1", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rd", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
  },
},
/*CLAMPI*/
{ 
  "CLAMPI", "CLAMPI %rd , %rs1 ",
  32,
  5,
  { 
    { "op_code0", 0, 6, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 5, 2, "2", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code2", 11, 11, 3, "3", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs1", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rd", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
  },
},
/*VALPRED*/
{ 
  "VALPRED", "VALPRED %rd , %rs1 , %rs2 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 8, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
...
static void insn_exec_CLAMPV (insn_info_t *insn, int32_t *operands);
static void insn_exec_CLAMPI (insn_info_t *insn, int32_t *operands);
static void insn_exec_VALPRED (insn_info_t *insn, int32_t *operands);
>>>>)
...
#define behavior_INIT__CLAMPV \
int32_t rs1 = operands[0];\
int32_t rd = operands[1];\

#define behavior_INIT__CLAMPI \
int32_t rs1 = operands[0];\
int32_t rd = operands[1];\

#define behavior_INIT__VALPRED \
