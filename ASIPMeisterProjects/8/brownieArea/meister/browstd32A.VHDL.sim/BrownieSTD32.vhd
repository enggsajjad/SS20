...
-- Generated by ASIP Meister 2.3 on 2020/06/18 17:57:20 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  end component rtg_mux11to1_w32;
  ...
  signal unused_04 : std_logic_vector(63 downto 0);
...
begin
  ...
  UA_MUX05 : rtg_mux11to1_w32
    port map (
      SEL => ua_mux05_sel, 
      DIN0 => uf_alu_result, 
      DIN1 => uf_div_q, 
      DIN2 => uf_div_r, 
      DIN3 => uf_sftvar_data_out, 
      DIN4 => concat_01, 
      DIN5 => concat_02, 
      DIN6 => concat_03, 
      DIN7 => concat_04, 
      DIN8 => uf_ext8to32_data_out, 
      DIN9 => uf_ext16to32a_data_out, 
      DIN10 => ua_preg00_dout, 
      DOUT => ua_mux05_dout
    );
