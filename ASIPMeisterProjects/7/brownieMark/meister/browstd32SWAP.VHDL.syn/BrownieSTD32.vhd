...
-- Generated by ASIP Meister 2.3 on 2021/03/03 22:09:29 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal ua_altsel02_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_preg08_dout : std_logic;
  ...
  signal ua_mux27_dout : std_logic_vector(4 downto 0);
  signal ua_mux28_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux41_dout : std_logic_vector(15 downto 0);
  ...
  signal ua_mux46_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_mux45_dout : std_logic_vector(31 downto 0);
  signal ua_mux47_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_mux52_dout : std_logic_vector(4 downto 0);
  signal ua_mux53_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux57_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_mux12_sel : std_logic_vector(4 downto 0);
  signal ua_mux13_sel : std_logic;
  signal ua_mux14_sel : std_logic;
  signal ua_mux15_sel : std_logic_vector(4 downto 0);
  signal ua_mux16_sel : std_logic;
  signal ua_mux17_sel : std_logic_vector(2 downto 0);
  ...
  signal ua_mux22_sel : std_logic_vector(4 downto 0);
  signal ua_mux23_sel : std_logic;
  signal ua_mux24_sel : std_logic;
  signal ua_mux25_sel : std_logic_vector(4 downto 0);
  ...
  signal ua_mux36_sel : std_logic_vector(4 downto 0);
  ...
  signal ua_mux52_sel : std_logic;
  signal ua_mux53_sel : std_logic;
  ...
  signal ua_mux54_sel : std_logic;
  signal ua_mux55_sel : std_logic;
  signal ua_mux56_sel : std_logic;
  signal ua_mux57_sel : std_logic;
  signal ua_mux58_sel : std_logic;
  signal ua_mux59_sel : std_logic;
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux57_dout, 
      w_sel1 => ua_preg27_dout, 
      data_in0 => ua_mux58_dout, 
      data_in1 => ua_preg30_dout, 
      r_sel0 => ua_mux39_dout, 
      r_sel1 => ua_mux40_dout, 
      data_out0 => uf_gpr_data_out0, 
      data_out1 => uf_gpr_data_out1, 
      status_out => uf_gpr_status_out, 
      status_in => ua_mux59_dout, 
  ...
  UA_ALTSEL02 : rtg_mux2to1_w32
    port map (
      SEL => cmpneq_02, 
      DIN0 => ua_preg04_dout, 
      DIN1 => uf_dmau_data_in, 
      DOUT => ua_altsel02_dout
    );
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLIN_BITNOT_03_EXE_WB => ua_preg08_dout, 
  ...
  UA_MUX12 : rtg_mux17to1_w32
    port map (
      ...
      DIN14 => ua_altsel01_dout, 
      DIN15 => ua_altsel02_dout, 
      DIN16 => ua_preg12_dout, 
      DOUT => ua_mux12_dout
    );
  ...
  UA_MUX34 : rtg_mux2to1_w5
    port map (
      SEL => ua_mux34_sel, 
      DIN0 => bitrange16to12_00, 
      DIN1 => bitrange26to22_00, 
      DOUT => ua_mux34_dout
    );
  ...
  UA_MUX38 : rtg_mux3to1_w32
    port map (
      SEL => ua_mux38_sel, 
      DIN0 => ua_altsel01_dout, 
      DIN1 => ua_altsel00_dout, 
      DIN2 => ua_preg02_dout, 
      DOUT => ua_mux38_dout
    );

  UA_MUX39 : rtg_mux5to1_w5
    port map (
      SEL => ua_mux39_sel, 
      DIN0 => bitrange31to27_00, 
      DIN1 => bitrange15to11_00, 
  ...
  UA_MUX41 : rtg_mux2to1_w16
    port map (
      SEL => ua_mux41_sel, 
      DIN0 => bitrange15to0_01, 
      DIN1 => bitrange31to16_00, 
      DOUT => ua_mux41_dout
    );
  ...
  UA_MUX45 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux45_sel, 
      DIN0 => uf_ext16to32_data_out, 
      DIN1 => uf_ext16to32a_data_out, 
      DOUT => ua_mux45_dout
    );

  UA_MUX46 : rtg_mux3to1_w32
    port map (
      SEL => ua_mux46_sel, 
      DIN0 => ua_altsel01_dout, 
      DIN1 => ua_altsel00_dout, 
  ...
  const_5h01 <= "00001";
  bitrange31to16_01 <= ua_preg02_dout(31 downto 16);
  ...
  cmpneq_02 <= 
	'1' when concat_02 /= "00000000000000000000000000000000" else 
	'0';
  const_32h00000004 <= "00000000000000000000000000000100";
  bitnot_03 <= not cmpneq_02;
