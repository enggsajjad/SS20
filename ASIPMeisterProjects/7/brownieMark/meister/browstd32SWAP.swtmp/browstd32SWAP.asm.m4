...
{ 
  ...
  { 
    ...
    { "constt", 16, 16, 0, "0", "", E_INSN_FIELD_TYPE__IMMEDIATE, brownie32_encode_immediate_field_type, brownie32_decode_immediate_field_type, brownie32_parse_immediate_field_type},
  },
},
/*AVG*/
{ 
...
/*SWAPIFL*/
{ 
  "SWAPIFL", "SWAPIFL %rdMin , %rdMax , %rs1 , %rs2 ",
  32,
  6,
  { 
...
/*SWAPGTE*/
{ 
  "SWAPGTE", "SWAPGTE %rd , %rs1 , %rs2 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 8, 8, "8", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code2", 14, 3, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rd", 17, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs2", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
...
/*BGEUN*/
{ 
  "BGEUN", "BGEUN %rs1 , %rs2 , %constt ",
  32,
  4,
  { 
    { "op_code0", 0, 6, 20, "20", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs2", 6, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 11, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "constt", 16, 16, 0, "0", "", E_INSN_FIELD_TYPE__IMMEDIATE, brownie32_encode_immediate_field_type, brownie32_decode_immediate_field_type, brownie32_parse_immediate_field_type},
  },
...
/*BGTE*/
{ 
  "BGTE", "BGTE %rs1 , %rs2 , %constt ",
  32,
  4,
  { 
    { "op_code0", 0, 6, 24, "24", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs2", 6, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 11, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "constt", 16, 16, 0, "0", "", E_INSN_FIELD_TYPE__IMMEDIATE, brownie32_encode_immediate_field_type, brownie32_decode_immediate_field_type, brownie32_parse_immediate_field_type},
  },
...
/*MSWAPT*/
{ 
  "MSWAPT", "MSWAPT %rdMin , %rdMax , %rs1 , %rs2 ",
  32,
  6,
  { 
...
/*SWAPTR*/
{ 
  "SWAPTR", "SWAPTR %rs1 , %rs2 ",
  32,
  4,
  { 
    { "op_code0", 0, 6, 52, "52", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 16, 0, "0", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs2", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
  },
},
...
static void insn_exec_SWAPIFL (insn_info_t *insn, int32_t *operands);
static void insn_exec_SWAPGTE (insn_info_t *insn, int32_t *operands);
static void insn_exec_BGEUN (insn_info_t *insn, int32_t *operands);
static void insn_exec_BGTE (insn_info_t *insn, int32_t *operands);
static void insn_exec_MSWAPT (insn_info_t *insn, int32_t *operands);
static void insn_exec_SWAPTR (insn_info_t *insn, int32_t *operands);
>>>>)
...
#define behavior_INIT__SWAPIFL \
int32_t rdMax = operands[0];\
int32_t rdMin = operands[1];\
int32_t rs2 = operands[2];\
int32_t rs1 = operands[3];\

#define behavior_INIT__SWAPGTE \
int32_t rd = operands[0];\
int32_t rs2 = operands[1];\
int32_t rs1 = operands[2];\

#define behavior_INIT__BGEUN \
int32_t rs2 = operands[0];\
int32_t rs1 = operands[1];\
int32_t constt = operands[2];\

#define behavior_INIT__BGTE \
int32_t rs2 = operands[0];\
int32_t rs1 = operands[1];\
int32_t constt = operands[2];\

#define behavior_INIT__MSWAPT \
int32_t rdMax = operands[0];\
int32_t rdMin = operands[1];\
int32_t rs2 = operands[2];\
int32_t rs1 = operands[3];\

#define behavior_INIT__SWAPTR \
int32_t rs2 = operands[0];\
int32_t rs1 = operands[1];\
