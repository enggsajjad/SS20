...
// Generated by ASIP Meister 2.3 on 2021/02/27 01:01:14 
Design{
Version{"2.3"},
...
,"BR2"{
"Operand"{"name"{"constt"},width{"31","16"}},
"Operand"{"name"{"rs1"},width{"15","11"}},
...
"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"OP-code"{"binary"{"0000000000000000"},width{"21","6"}},
"OP-code"{"name"{"op"},width{"5","0"}}
}
}}}},
...
"OP-code"{"binary"{"00000101"},width{"13","6"}},
"OP-code"{"binary"{"000001"},width{"5","0"}}
},"BGEU"{type{"BR2"},"Operand"{"name"{"constt"},width{"31","16"}},
"Operand"{"name"{"rs1"},width{"15","11"}},
"Operand"{"name"{"rs2"},width{"10","6"}},
...
},"SWAPIFL"{type{"RR2"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rdMin"},width{"21","17"}},
"Operand"{"name"{"rdMax"},width{"16","12"}},
"OP-code"{"binary"{"000000"},width{"11","6"}},
"OP-code"{"binary"{"010011"},width{"5","0"}}
},"BGEUN"{type{"BR2"},"Operand"{"name"{"constt"},width{"31","16"}},
"Operand"{"name"{"rs1"},width{"15","11"}},
"Operand"{"name"{"rs2"},width{"10","6"}},
"OP-code"{"binary"{"010100"},width{"5","0"}}
},"SWAPGTE"{type{"RR"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rd"},width{"21","17"}},
"OP-code"{"binary"{"001"},width{"16","14"}},
"OP-code"{"binary"{"00001000"},width{"13","6"}},
"OP-code"{"binary"{"000001"},width{"5","0"}}
},"BGTE"{type{"BR2"},"Operand"{"name"{"constt"},width{"31","16"}},
"Operand"{"name"{"rs1"},width{"15","11"}},
"Operand"{"name"{"rs2"},width{"10","6"}},
"OP-code"{"binary"{"011000"},width{"5","0"}}
},"MSWAPT"{type{"RR2"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rdMin"},width{"21","17"}},
"Operand"{"name"{"rdMax"},width{"16","12"}},
"OP-code"{"binary"{"000000"},width{"11","6"}},
"OP-code"{"binary"{"110101"},width{"5","0"}}
},"SWAPTR"{type{"RRSWAP"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"OP-code"{"binary"{"0000000000000000"},width{"21","6"}},
...
gpr_double_read_stmp1   = GPR.read0(rs1);
gpr_double_read_stmp2   = GPR.read1(rs2);
gpr_read_ext16to32_stmp2 = EXT16TO32.sign(constt);
...
,"SWAPIFL"{variable{"//wire [31:0] cmp_result;
wire [31:0] src1;
wire [31:0] src2;
/* these variables can be used in following stages of all instructions */
wire [31:0]  source1;
...
//cond=1 when source1 < source2
//then swap
src1 = (cond) ? source2:source1;
src2 = (cond) ? source1:source2;

//Two Register Forwarding:
// foward src1 to as GPR[rdMin] from stage EXE
null = FWU0.forward1(rdMin, src1);
null = FWU1.forward1(rdMin, src1);
// foward src2 to as GPR[rdMax] from stage EXE
null = FWU2.forward1(rdMax, src2);
null = FWU3.forward1(rdMax, src2);"},
clk(4){"null = GPR.write0(rdMin, src1);
null = GPR.write1(rdMax, src2);

//Two Register Forwarding:
// foward src1 to as GPR[rdMin] from stage WB
null = FWU0.forward2(rdMin, src1);
null = FWU1.forward2(rdMin, src1);
// foward src2 to as GPR[rdMax] from stage WB
null = FWU2.forward2(rdMax, src2);
null = FWU3.forward2(rdMax, src2);"}
}
,"BGEUN"{variable{"/* these variables can be used in following stages of all instructions */
wire [31:0] pcread_result;
wire [31:0]  source1;
wire [31:0]  source2;
wire [31:0]  source3;
...
alu_cmp_alu_flag = ALU.cmp(source2, source1);
...
source1  = FWU0.forward(rs1, gpr_double_read_stmp1);
source2  = FWU1.forward(rs2, gpr_double_read_stmp2);"},
clk(3){"wire [31:0] four;
wire [31:0] read_addr;
wire [3:0] addr_alu_flag;
wire [30:0] zero;
wire [31:0] cmp_result;
wire swap_cond;
wire [3:0] alu_cmp_alu_flag;
...
wire       alu_cmp_lt_cond2;
wire       alu_cmp_carry;
wire        load_read_addr_err;

four = \"00000000000000000000000000000100\"; 
<read_addr, addr_alu_flag> = ALU1.add(source1, four);
// result is 32bit data. already extended
<load_result, load_read_addr_err> = DMAU.ld_32(read_addr);
alu_cmp_alu_flag = ALU.cmp(source2, load_result);
...
cmp_ult            = ~alu_cmp_carry;
zero       = \"0000000000000000000000000000000\"; // 31 bits zeros
cmp_result = <zero, cmp_ult>;
swap_cond = cmp_result != \"00000000000000000000000000000000\";

big = (swap_cond) ? load_result:source2;

not_swap_cond = ~swap_cond;
// foward big to as GPR[rd] from stage EXE
null = FWU0.forward1(rd, big);
null = FWU1.forward1(rd, big);"},
clk(4){"wire store_addr_err;

null = GPR.write0(rd, big);        // write big[arg2] to GPR[arg1]
store_addr_err = [not_swap_cond] DMAU.s_32(source1, load_result);
// foward big to as GPR[rd] from stage WB
null = FWU0.forward2(rd, big);
null = FWU1.forward2(rd, big);"}
}
,"BGTE"{variable{"wire [31:0] cmp_result;
wire [31:0] s3;
/* these variables can be used in following stages of all instructions */
/* these variables can be used in following stages of all instructions */
wire [31:0] pcread_result;
...
source2  = FWU1.forward(rs2, gpr_double_read_stmp2);
pcread_result = PC.read();
s3 = EXT16TO32A.sign(constt);

//s3 = gpr_double_read_ext16to32_stmp3;"},
clk(3){"wire [30:0] zero;
wire [31:0] s33;
wire [3:0] alu_cmp_alu_flag;
wire [1:0] alu_cmp_tmp_flag;
...
//s3 = \"00000000000000000000000000010000\";
s33 = s3;
// evaluate cmp_result equal or not equal to zero
relative_branchz_cond = cmp_result != \"00000000000000000000000000000000\";

// branch according to the cond
<relative_branchz_abs_addr, relative_branchz_alu_flag> 
                     = ALU1.add(pcread_result, s33);  // calu. absolute address
null                 = [relative_branchz_cond] PC.write(relative_branchz_abs_addr); // branch"},
clk(4){""}
}
,"MSWAPT"{variable{"// copy and modify from SWAPIFL
wire [31:0] src1;
wire [31:0] src2;
/* these variables can be used in following stages of all instructions */
wire [31:0]  source1;
...
,"SWAPTR"{variable{"// same like MSWAPT, but without additional destination registers
wire [31:0] src1;
wire [31:0] src2;
/* these variables can be used in following stages of all instructions */
wire [31:0]  source1;
...
//Two Register Forwarding:
// foward src1 to as GPR[rs1] from stage EXE
null = FWU0.forward1(rs1, src1);
null = FWU1.forward1(rs1, src1);
// foward src2 to as GPR[rs2] from stage EXE
null = FWU2.forward1(rs2, src2);
null = FWU3.forward1(rs2, src2);"},
clk(4){"null = GPR.write0(rs1, src1);
null = GPR.write1(rs2, src2);

//Two Register Forwarding:
// foward src1 to as GPR[rs1] from stage WB
null = FWU0.forward2(rs1, src1);
null = FWU1.forward2(rs1, src1);
// foward src2 to as GPR[rs2] from stage WB
null = FWU2.forward2(rs2, src2);
null = FWU3.forward2(rs2, src2);"}
}
}}
