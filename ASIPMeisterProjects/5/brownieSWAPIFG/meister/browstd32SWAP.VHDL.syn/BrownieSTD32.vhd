...
-- Generated by ASIP Meister 2.3 on 2020/07/04 03:27:07 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal ua_preg11_dout : std_logic;
  ...
  signal ua_mux35_dout : std_logic_vector(15 downto 0);
  ...
  signal ua_mux14_sel : std_logic_vector(4 downto 0);
  signal ua_mux15_sel : std_logic_vector(2 downto 0);
  ...
  signal ua_mux20_sel : std_logic_vector(4 downto 0);
  ...
  signal ua_mux31_sel : std_logic_vector(4 downto 0);
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux47_dout, 
      w_sel1 => ua_preg10_dout, 
      data_in0 => ua_mux48_dout, 
      data_in1 => ua_preg26_dout, 
      r_sel0 => ua_mux33_dout, 
      r_sel1 => ua_mux34_dout, 
      data_out0 => uf_gpr_data_out0, 
      data_out1 => uf_gpr_data_out1, 
      status_out => uf_gpr_status_out, 
      status_in => ua_mux49_dout, 
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      CTRLIN_BITNOT_03_EXE_WB => ua_preg11_dout, 
  ...
  bitor_01 <= ua_preg07_dout or const_32h00004300;
  ...
  concat_09 <= const_27h0000000 & ua_preg08_dout;
