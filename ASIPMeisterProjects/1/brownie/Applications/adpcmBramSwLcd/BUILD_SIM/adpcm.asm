...
_adpcm_decoder:
;  Function 'adpcm_decoder'; 44 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	addi	r6,r0,#0
	sw	-8(r4),r6
	addi	r6,r0,%hi(LC_adpcm_0)
	lsoi	r6,r6,%lo(LC_adpcm_0)
	sw	-4(r4),r6
...
L_adpcm_23:
	...
	eneq	r6,r7,r6
	brnz	r6,L_adpcm_25
	addi	r6,r0,%hi(LC_adpcm_2)
	lsoi	r6,r6,%lo(LC_adpcm_2)
	sw	-4(r4),r6
	jp	L_adpcm_27
L_adpcm_25:
	addi	r6,r0,%hi(LC_adpcm_3)
	lsoi	r6,r6,%lo(LC_adpcm_3)
	sw	-4(r4),r6
L_adpcm_27:
	lw	r6,-8(r4)
	nop
...
L_adpcm_2:
	...
	elt	r6,r7,r6
	brnz	r6,L_adpcm_3
	addi	r8,r0,%hi(LC_adpcm_4)
	lsoi	r8,r8,%lo(LC_adpcm_4)
	jpl	_t_print
	addi	r6,r0,#0
	nop
...
;  Function 'main'; 40 bytes of locals, 0 regs to save, 32 byte of out. args. size.
	...
	addi	r6,r0,#1300
	sw	-8(r4),r6
	addi	r8,r0,%hi(LC_adpcm_5)
	lsoi	r8,r8,%lo(LC_adpcm_5)
	jpl	_t_print
	...
	sub	r6,r7,r6
	sw	-4(r4),r6
	addi	r8,r0,%hi(LC_adpcm_6)
	lsoi	r8,r8,%lo(LC_adpcm_6)
	jpl	_t_print
	addi	r8,r0,%hi(LC_adpcm_7)
	lsoi	r8,r8,%lo(LC_adpcm_7)
	jpl	_t_print
	addi	r6,r4,#-40
	lw	r8,-4(r4)
	nop
	...
	add	r8,r0,r6
	jpl	_t_print
	addi	r8,r0,%hi(LC_adpcm_8)
	lsoi	r8,r8,%lo(LC_adpcm_8)
	jpl	_t_print
	addi	r6,r0,#0
	lw	r3,4(r4)	; pop LinkRegister(r3)
	addi	r5,r4,#8	; StackPointer = FramePointer+8
